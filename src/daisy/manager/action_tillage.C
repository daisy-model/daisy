...
struct ActionMixSyntax : DeclareModel
{
...
struct ActionSwapSyntax : DeclareModel
{
  Model* make (const BlockModel& al) const
...
struct ActionSetPorositySyntax : DeclareModel
{
  Model* make (const BlockModel& al) const
...
struct ActionRemoveLitterSyntax : DeclareModel
{
  Model* make (const BlockModel& al) const
...
struct ActionStoreSOMSyntax : DeclareModel
{
  Model* make (const BlockModel& al) const
...
struct ActionRestoreSOMSyntax : DeclareModel
{
  Model* make (const BlockModel& al) const
...
{
  static ActionMixSyntax action_mix_syntax;
  static ActionSwapSyntax action_swap_syntax;
  static ActionSetPorositySyntax action_set_porosity_syntax;
  static ActionRemoveLitterSyntax action_remove_litter_syntax;
  static ActionStoreSOMSyntax action_store_som_syntax;
  static ActionRestoreSOMSyntax action_restore_som_syntax;
}
